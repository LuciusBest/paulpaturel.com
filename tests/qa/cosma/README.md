...
## How it works
- paragraphs loaded via the shared loader `js/data/projectTexts.js` (one fetch per language, cached for all consumers)
...
- include the data loader first: `<script src="js/data/projectTexts.js" defer></script>`
- include the overlay right after: `<script src="js/overlay/dynamicTextOverlay.js" defer></script>`
